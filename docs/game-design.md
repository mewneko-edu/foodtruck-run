...
主要互動界面採一體化橫向滑動，劃分為左、中、右三個互相連通的餐車空間。詳細畫面流程見 [UI_flow.md](UI_flow.md)。

### 全局固定 HUD（不隨頁面滑動改變）

* **頂部常駐欄：** 設定 ⚙️｜收藏圖鑑 📖（麵包、食材、明信片、客人）｜金幣 🪙｜今日步數/里程 🌾
* **底部常駐欄：** 餐車裝潢按鈕 🛠️（打開商城，消耗金幣購買外裝飾品、內飾桌椅、廚房物件）
...
* **互動點：**
    ...
    * **拖曳餵食：** 下方常駐「麵包籃」，將麵包拖曳至動物身上即可餵食，獲得金幣
